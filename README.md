About jupyterlite-core-feedstock
================================
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-jupyterlite--core--with--mathjax-green.svg)](https://anaconda.org/conda-forge/jupyterlite-core-with-mathjax) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/jupyterlite-core-with-mathjax.svg)](https://anaconda.org/conda-forge/jupyterlite-core-with-mathjax) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/jupyterlite-core-with-mathjax.svg)](https://anaconda.org/conda-forge/jupyterlite-core-with-mathjax) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/jupyterlite-core-with-mathjax.svg)](https://anaconda.org/conda-forge/jupyterlite-core-with-mathjax) |
...
Once the `conda-forge` channel has been enabled, `jupyterlite-core, jupyterlite-core-with-all, jupyterlite-core-with-check, jupyterlite-core-with-contents, jupyterlite-core-with-lab, jupyterlite-core-with-libarchive, jupyterlite-core-with-mathjax, jupyterlite-core-with-serve, jupyterlite-core-with-translation, jupyterlite-javascript-kernel` can be installed with `conda`:

```
conda install jupyterlite-core jupyterlite-core-with-all jupyterlite-core-with-check jupyterlite-core-with-contents jupyterlite-core-with-lab jupyterlite-core-with-libarchive jupyterlite-core-with-mathjax jupyterlite-core-with-serve jupyterlite-core-with-translation jupyterlite-javascript-kernel
```

or with `mamba`:

```
mamba install jupyterlite-core jupyterlite-core-with-all jupyterlite-core-with-check jupyterlite-core-with-contents jupyterlite-core-with-lab jupyterlite-core-with-libarchive jupyterlite-core-with-mathjax jupyterlite-core-with-serve jupyterlite-core-with-translation jupyterlite-javascript-kernel
```
